...
class LegacyImage(models.Model):
    ...
    image = models.ImageField(
        upload_to="legacy_images"
    )  # Or some other field type, depending on how you're storing the frame
    ...
    def get_classification_annotations_by_label_and_value(
        ...
        """
        return ImageClassificationAnnotation.objects.filter(
            legacy_image=self, label=label, value=value
        )
