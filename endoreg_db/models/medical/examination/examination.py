...
class Examination(models.Model):
    ...
    if TYPE_CHECKING:
        ...
        indications = cast("models.manager.Manager[ExaminationIndication]", indications)
        examination_times = cast("models.manager.Manager[ExaminationTime]", examination_times)
        ...
        @property
        def exam_reqset_links(self) -> "models.manager.Manager[ExaminationRequirementSet]": ...
