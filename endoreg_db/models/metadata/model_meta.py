...
class ModelMeta(models.Model):
    ...
    version: models.CharField[str, str] = models.CharField(
        max_length=255,
        help_text="Version identifier for this metadata set (e.g., '1', '2a').",
    )
    model: models.ForeignKey["AiModel", "AiModel"] = models.ForeignKey(
        "AiModel",
    ...
    labelset: models.ForeignKey["LabelSet", "LabelSet"] = models.ForeignKey(
        "LabelSet",
        on_delete=models.CASCADE,
        related_name="model_metadata",
        help_text="The set of labels this model version predicts.",
    )
    activation: models.CharField[str, str] = models.CharField(
        max_length=50,
        default="sigmoid",
