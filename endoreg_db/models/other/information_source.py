...
class InformationSource(models.Model):
    ...
    if TYPE_CHECKING:
        ...
        @property
        def examination_indications(self) -> "models.manager.Manager[ExaminationIndication]": ...

        @property
        def examination_times(self) -> "models.manager.Manager[ExaminationTime]": ...

        @property
        def findings(self) -> "models.manager.Manager[Finding]": ...

        @property
        def finding_interventions(self) -> "models.manager.Manager[FindingIntervention]": ...
