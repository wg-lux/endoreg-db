...
class RawVideoFile(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.video_meta is None:
            ...
            self.video_meta = VideoMeta.objects.create(center=center, processor = processor)
    ...
    def extract_frames(
        ...
        command = [
            ...
            "-q:v",
            str(quality),
            os.path.join(frame_dir, f"frame_%07d.{ext}"),
        ]
        ...
        return f"Frames extracted to {frame_dir}"
