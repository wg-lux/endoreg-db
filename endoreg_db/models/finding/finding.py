...
class Finding(models.Model):
    ...
    examinations = models.ManyToManyField(
        "Examination", blank=True, related_name="findings"
    )
    ...
    causing_finding_interventions = models.ManyToManyField(
        "FindingIntervention", blank=True, related_name="causing_findings"
    )

    opt_causing_finding_interventions = models.ManyToManyField(
        "FindingIntervention", blank=True, related_name="opt_causing_findings"
    )
    ...
    def get_location_classifications(self):
        ...
        location_classifications: FindingLocationClassification = (
            self.location_classifications.all()
        )
    ...
    def get_required_morphology_classification_types(self):
        ...
        finding_morphology_classification_types: List[
            FindingMorphologyClassificationType
