...
class FindingLocationClassification(models.Model):
    ...
    findings = models.ManyToManyField(
        "Finding", blank=True, related_name="location_classifications"
    )
    examinations = models.ManyToManyField(
        "Examination", blank=True, related_name="location_classifications"
    )
    finding_types = models.ManyToManyField(
        "FindingType", blank=True, related_name="location_classifications"
    )
    choices = models.ManyToManyField(
        "FindingLocationClassificationChoice",
        blank=True,
        related_name="location_classifications",
    )
    ...
    def remove_unavailable_findings(self, findings):
        """
        ...
        available_finding_names = [finding.name for finding in available_findings]
