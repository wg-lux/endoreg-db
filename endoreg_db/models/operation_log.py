...
class OperationLog(models.Model):
    ...
    # Who did it
    actor_user: models.ForeignKey["models.Model | None", "models.Model | None"] = (
    ...
    actor_keycloak_id: models.CharField[str, str] = models.CharField(
        max_length=255,
        blank=True,
    ...
    http_method: models.CharField[str, str] = models.CharField(
        max_length=10, blank=True
    )
    path: models.CharField[str, str] = models.CharField(max_length=512, blank=True)

    # On what resource
    resource_type: models.CharField[str, str] = models.CharField(
        max_length=50,
        blank=True,
        help_text="e.g. 'video', 'pdf'",
    )
    resource_id: models.IntegerField[int | None, int | None] = models.IntegerField(
        null=True,
        blank=True,
