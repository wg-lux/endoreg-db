...
def fetch_template(template_name: str = TEMPLATE_NAME) -> CaseTemplate:
    """
    Fetches a CaseTemplate by name.

    Args:
        template_name (str): The name of the template to fetch. Defaults to TEMPLATE_NAME.
...
def initialize_case_generator(
    ...
    Args:
        template_name (str): The name of the template to use. Defaults to TEMPLATE_NAME.
