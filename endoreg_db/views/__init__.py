...
_IMPORT_TARGETS: dict[str, tuple[str, str]] = {
    "build_multilingual_response": ("endoreg_db.utils.translation", "build_multilingual_response"),
    "AnonymizationOverviewView": ("endoreg_db.views.anonymization", "AnonymizationOverviewView"),
    "AnonymizationValidateView": ("endoreg_db.views.anonymization", "AnonymizationValidateView"),
    "anonymization_current": ("endoreg_db.views.anonymization", "anonymization_current"),
    ...
    "ExaminationManifestCache": ("endoreg_db.views.examination", "ExaminationManifestCache"),
    ...
    "get_classifications_for_examination": ("endoreg_db.views.examination", "get_classifications_for_examination"),
    "get_findings_for_examination": ("endoreg_db.views.examination", "get_findings_for_examination"),
    "get_instruments_for_examination": ("endoreg_db.views.examination", "get_instruments_for_examination"),
    "get_interventions_for_examination": ("endoreg_db.views.examination", "get_interventions_for_examination"),
    ...
    "get_classifications_for_finding": ("endoreg_db.views.finding", "get_classifications_for_finding"),
    "get_interventions_for_finding": ("endoreg_db.views.finding", "get_interventions_for_finding"),
    "FindingClassificationViewSet": ("endoreg_db.views.finding_classification", "FindingClassificationViewSet"),
    "get_classification_choices": ("endoreg_db.views.finding_classification", "get_classification_choices"),
    "get_location_choices": ("endoreg_db.views.finding_classification", "get_location_choices"),
    "get_morphology_choices": ("endoreg_db.views.finding_classification", "get_morphology_choices"),
    "get_sensitive_metadata_pk": ("endoreg_db.views.media", "get_sensitive_metadata_pk"),
    "label_list": ("endoreg_db.views.media", "label_list"),
    "pdf_sensitive_metadata": ("endoreg_db.views.media", "pdf_sensitive_metadata"),
    "pdf_sensitive_metadata_list": ("endoreg_db.views.media", "pdf_sensitive_metadata_list"),
    "pdf_sensitive_metadata_verify": ("endoreg_db.views.media", "pdf_sensitive_metadata_verify"),
    ...
    "video_sensitive_metadata_verify": ("endoreg_db.views.media", "video_sensitive_metadata_verify"),
    "SensitiveMetaListView": ("endoreg_db.views.meta", "SensitiveMetaListView"),
    "SensitiveMetaVerificationView": ("endoreg_db.views.meta", "SensitiveMetaVerificationView"),
    ...
    "ExaminationCreateView": ("endoreg_db.views.patient_examination", "ExaminationCreateView"),
    "PatientExaminationDetailView": ("endoreg_db.views.patient_examination", "PatientExaminationDetailView"),
    "PatientExaminationListView": ("endoreg_db.views.patient_examination", "PatientExaminationListView"),
    "PatientExaminationViewSet": ("endoreg_db.views.patient_examination", "PatientExaminationViewSet"),
    "OptimizedPatientFindingViewSet": ("endoreg_db.views.patient_finding", "OptimizedPatientFindingViewSet"),
    "PatientFindingViewSet": ("endoreg_db.views.patient_finding", "PatientFindingViewSet"),
    "create_patient_finding_classification": (
        "endoreg_db.views.patient_finding_classification",
        "create_patient_finding_classification",
    ),
    "PatientExaminationReportViewSet": ("endoreg_db.views.report", "PatientExaminationReportViewSet"),
