...
from endoreg_db.models.medical.disease import DiseaseClassificationChoice as MODEL_0
...
class LoadDiseaseClassificationChoicesCommandOptions(TypedDict):
    verbose: bool
...
class Command(BaseCommand):
    ...
    def handle(
        self,
        *args: str,
        **options: Unpack[LoadDiseaseClassificationChoicesCommandOptions],
    ) -> None:
