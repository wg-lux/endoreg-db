...
class LocalStudyServerPreanonymizedIngestPayload(PreanonymizedIngestPayload):
    ...
    @classmethod
    def _require_present_string(cls, value: str | None) -> str:
        if value is None:
    ...
    @classmethod
    def _require_human_validation(cls, value: bool | None) -> bool:
    ...
    @classmethod
    def _require_timezone_aware_validated_at(cls, value: datetime | None) -> datetime:
        if value is None:
            raise ValueError("validated_at is required")
