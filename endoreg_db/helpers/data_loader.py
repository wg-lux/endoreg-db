...
def load_default_ai_model(): 
    """
    Loads the default AI model into the database using a predefined model checkpoint.
    
    The function constructs the path to the default AI model checkpoint within the assets directory and invokes the Django management command to register the model metadata.
    """
...
def load_qualification_data():
    """
    Loads qualification data into the database by invoking the corresponding Django management command.
    """
...
def load_endoscope_data():
    """
    Loads endoscope data into the database by invoking the corresponding management command.
    """
...
def load_report_reader_flag_data():
    """
    Loads report reader flag data into the database by invoking the corresponding Django management command.
    """
    call_command("load_report_reader_flag_data", )
    
def load_pdf_type_data():
    """
    Loads PDF type data into the database by invoking the corresponding management command.
    """
...
def load_disease_data():
    """
    Loads disease data into the database using the corresponding management command.
    """
...
def load_organ_data():
    """
    Loads organ-related data into the database using the corresponding management command.
    """
...
def load_lab_value_data():
    """
    Loads laboratory value data into the database using the corresponding management command.
    """
    call_command("load_lab_value_data", )
    
def load_finding_data():
    """
    Loads finding data into the database by invoking the corresponding management command.
    """
    call_command("load_finding_data", )
    
def load_examination_indication_data():
    """
    Loads examination indication data into the database using the corresponding management command.
    """
    call_command("load_examination_indication_data", )
    
def load_medication_data():
    """
    Loads medication data into the database by invoking the corresponding Django management command.
    """
...
def load_requirement_data():
    ...
    """
    Loads requirement data into the database by invoking the corresponding management command.
    """
    call_command("load_requirement_data", )

def load_ai_model_label_data():
    """
    Loads AI model label data into the database using the corresponding management command.
    """
    call_command("load_ai_model_label_data", )

def load_ai_model_data():    
    """
    Loads AI model data into the database by invoking the corresponding management command.
    """
    call_command("load_ai_model_data", )

def load_green_endoscopy_wuerzburg_data():
    """
    Loads the Green Endoscopy Wuerzburg dataset into the database by invoking the corresponding Django management command.
    """
    call_command("load_green_endoscopy_wuerzburg_data", )

def load_data():
    """
    Loads all required data sets into the database in the correct sequence.
    
    Calls individual data loading functions in a specific order to ensure dependencies are respected and the database is properly initialized with all necessary domain data.
    """
