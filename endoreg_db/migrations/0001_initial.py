    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=pathlib.PurePosixPath('data/frames'))),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_raw', models.BooleanField(default=False)),
                ('extracted', models.BooleanField(default=False)),
                ('image', models.ImageField(blank=True, null=True, upload_to=pathlib.PurePosixPath('data/raw_frames'))),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weights', models.FileField(blank=True, null=True, upload_to=pathlib.PurePosixPath('data/model_weights'), validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['ckpt'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_raw', models.BooleanField(default=False)),
                ('file', models.FileField(storage=django.core.files.storage.FileSystemStorage(location='/home/admin/dev/endoreg-db/data'), upload_to=pathlib.PurePosixPath('data/raw_videos'), validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp4'])])),
                ...
                ('center', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='endoreg_db.center')),
                ('examination', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='endoreg_db.patientexamination')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('file', models.FileField(storage=django.core.files.storage.FileSystemStorage(location=pathlib.PurePosixPath('data')), upload_to='data/raw_reports/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state_frames_initialized', models.BooleanField(default=False)),
                ('is_raw', models.BooleanField(default=False)),
                ('file', models.FileField(storage=django.core.files.storage.FileSystemStorage(location=pathlib.PurePosixPath('data')), upload_to=pathlib.PurePosixPath('data/videos'), validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp4'])])),
                ('date', models.DateField(blank=True, null=True)),
                ...
                ('patient', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='videos', to='endoreg_db.patient')),
                ('processor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='endoreg_db.endoscopyprocessor')),
