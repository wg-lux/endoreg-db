    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(location=pathlib.PurePosixPath('/home/admin/dev/lx-annotate/endoreg-db/storage')), upload_to=pathlib.PurePosixPath('pdfs'))),
                ('center', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='endoreg_db.center')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('file', models.FileField(storage=django.core.files.storage.FileSystemStorage(location=pathlib.PurePosixPath('/home/admin/dev/lx-annotate/endoreg-db/storage')), upload_to=pathlib.PurePosixPath('raw_pdfs'), validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw_file', models.FileField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(location=pathlib.PurePosixPath('/home/admin/dev/lx-annotate/endoreg-db/storage')), upload_to=pathlib.PurePosixPath('videos'), validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp4'])])),
                ('processed_file', models.FileField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(location=pathlib.PurePosixPath('/home/admin/dev/lx-annotate/endoreg-db/storage')), upload_to=pathlib.PurePosixPath('export/videos'), validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp4'])])),
