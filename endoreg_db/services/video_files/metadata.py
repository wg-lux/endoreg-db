...
def update_video_meta(video: "VideoFile", save_instance: bool = True):
    from endoreg_db.models.media.video.video_file_meta import _update_video_meta
...
def initialize_video_specs(video: "VideoFile", use_raw: bool = True) -> bool:
    from endoreg_db.models.media.video.video_file_meta import _initialize_video_specs

    return _initialize_video_specs(video, use_raw=use_raw)


def get_video_fps(video: "VideoFile") -> float:
    from endoreg_db.models.media.video.video_file_meta import _get_fps

    return _get_fps(video)


def get_video_endo_roi(video: "VideoFile", *args, **kwargs):
    from endoreg_db.models.media.video.video_file_meta import _get_endo_roi

    return _get_endo_roi(video, *args, **kwargs)


def get_video_crop_template(video: "VideoFile", *args, **kwargs):
    from endoreg_db.models.media.video.video_file_meta import _get_crop_template
...
def update_video_text_metadata(
    ...
    from endoreg_db.models.media.video.video_file_meta import _update_text_metadata
...
def ensure_default_video_fps(video: "VideoFile") -> float:
    from endoreg_db.models.media.video.video_file_time import _ensure_default_fps
...
def video_frame_number_to_seconds(video: "VideoFile", frame_number: int) -> float:
    from endoreg_db.models.media.video.video_file_time import _frame_number_to_s
