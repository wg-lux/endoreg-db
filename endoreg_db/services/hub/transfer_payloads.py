...
def build_video_transfer_payload(
    *,
    ...
    original_file_name = video.original_file_name or processed_path.name

    kv("Original filename", original_file_name)
    ...
    display_filename = video.original_file_name
    if not display_filename and processed_file_name:
        display_filename = Path(processed_file_name).name

    kv(
        "Original filename",
        display_filename or "<not set>",
    )
