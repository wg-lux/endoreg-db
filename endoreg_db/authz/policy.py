...
REQUIRED_ROLES = {
    # Patients
    "patient-list":   "data:read",  # GET /api/patients/   (list)   → require editors
...
'''def satisfies(user_roles: set[str], needed: str) -> bool:
    ...
    return False'''
#write has no read access for testing
def satisfies(user_roles: set[str], needed: str) -> bool:
    # STRICT: require the exact role
    return needed in user_roles
