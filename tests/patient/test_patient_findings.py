...
class TestGeneratePatientFindings(TestCase):
            ...
            for location_choice in location_choices:
                    ...
                    if required:
                        ...
                        if subcategory_choices:
                            for choice in subcategory_choices:
                                ...
                                patient_finding_location = (
                                    patient_finding.add_location_choice(
                ...
                for (
                    ...
                    if required:
                        ...
                        patient_finding_location.set_random_numerical_descriptor(
                            numerical_descriptor
                        )
    ...
    def test_create_colonoscopy_polyp_morphologies(self):
        ...
        req_morphology_classification_types = (
            finding_polyp.get_required_morphology_classification_types()
        )
                    ...
                    if required:
                        ...
                        if subcategory_choices:
                            for choice in subcategory_choices:
                                ...
                                patient_finding_morphology = (
                                    patient_finding.add_morphology_choice(
