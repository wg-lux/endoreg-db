...
from endoreg_db.models.metadata.sensitive_meta_logic import parse_any_date, format_date_german, format_date_iso
...
class TestSensitiveMetaValidateSerializer:
    ...
    def test_anonymized_text_field(self):
        ...
        serializer = SensitiveMetaValidateSerializer(data=data)
        assert serializer.is_valid()
        assert serializer.validated_data['anonymized_text'] == 'This is anonymized text content'
