...
from endoreg_db.serializers.video.video_processing_history import VideoProcessingHistorySerializer
...
class TestVideoProcessingHistorySerializer:  # pylint: disable=too-many-public-methods
    ...
    def test_validate_config_not_dict(self):
        ...
        serializer = VideoProcessingHistorySerializer(data={
            'operation': VideoProcessingHistory.OPERATION_MASKING,
            'config': "not a dict"
        })
        
        # Set initial_data to simulate the validation context
        serializer.initial_data = {'operation': VideoProcessingHistory.OPERATION_MASKING}
    ...
    def test_all_fields_present(self, video_file):
        ...
        expected_fields = [
            'id', 'video', 'operation', 'operation_display',
            'status', 'status_display', 'config', 'output_file',
            'download_url', 'details', 'task_id', 'created_at',
            'completed_at', 'duration', 'is_complete'
        ]
