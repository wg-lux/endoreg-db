...
@pytest.mark.xfail(reason="Needs minimal clinical fixtures + migration in test db for PatientExaminationReport")
...
@pytest.mark.django_db
@pytest.mark.xfail(reason="Needs deterministic fixture setup for versioned report objects")
