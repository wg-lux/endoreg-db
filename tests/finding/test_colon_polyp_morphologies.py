...
class ColonPolypMorphologyTest(TestCase):
    ...
    def test_colon_polyp_morphologies(self):
        ...
        self.assertGreater(
            len(colon_polyp_morphologies),
            0,
            "Colonoscopy should have morphology classifications for 'colon polyp' finding.",
        )
        ...
        self.assertIn(
            "colon_lesion_paris",
            morphology_names,
            "Colonoscopy should have 'colon_lesion_paris' morphology classification for 'colon polyp' finding.",
        )
        self.assertIn(
            "colon_lesion_nice",
            morphology_names,
            "Colonoscopy should have 'colon_lesion_nice' morphology classification for 'colon polyp' finding.",
        )
