...
class ColonPolypLocationTest(TestCase):
    ...
    def test_colon_polyp_locations(self):
        ...
        self.assertIsNotNone(
            colon_polyp_finding,
            "Colonoscopy should have a 'colon polyp' finding associated with it.",
        )
        ...
        self.assertTrue(
            colon_polyp_locations.exists(),
            "Colonoscopy should have colon polyp locations associated with it.",
        )
        ...
        self.assertIn(
            "colonoscopy_location_coarse",
            names,
            "Colonoscopy should have 'colonoscopy_location_coarse' location associated with it.",
        )
        self.assertIn(
            "colonoscopy_location_default",
            names,
            "Colonoscopy should have 'colonoscopy_location_default' location associated with it.",
        )
