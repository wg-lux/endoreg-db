...
from endoreg_db.models import ProductGroup, ReferenceProduct
...
class ProductGroupModelTest(TestCase):
    ...
    def test_product_groups_have_products(self):
        ...
        for product_group in product_groups:
            ...
            self.assertTrue(
                products.exists(), f"Product group {product_group} has no products."
            )
    ...
    def test_product_group_has_reference_product(self):
        ...
        for product_group in product_groups:
            ...
            self.assertIsInstance(
                reference_product,
                ReferenceProduct,
                f"Product group {product_group} has no reference product.",
            )
