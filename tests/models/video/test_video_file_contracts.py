...
from endoreg_db.models import Center, EndoscopyProcessor, VideoFile, VideoMeta
...
def test_video_file_import_context_names_prefer_video_processor(
    ...
    canonical_processor = EndoscopyProcessor.objects.create(
        name="processor-canonical"
    )
