...
class RequirementOperatorCountTests(TestCase):
    ...
    def _make_requirement(
        ...
        *,
        ...
        requirement.requirement_types.add(self.rt_patient, self.rt_patient_event)[attr - defined]
        requirement.operators.add(self.operators[operator_name])[attr - defined]
        for event in events:
            requirement.events.add(event)[attr - defined]
        return requirement
