...
from ..helpers.default_objects import generate_gender, generate_patient
...
class RequirementSetEvaluationTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.hb, _ = LabValue.objects.get_or_create(
            ...
            defaults={
                ...
                "name_en": "Hemoglobin",
                "value_type": "numeric",
                "numeric_normal_min": 12.0,
                "numeric_normal_max": 16.0,
                "unit": cls.g_dl,
            },
        )
        cls.wbc, _ = LabValue.objects.get_or_create(
            ...
            defaults={
                ...
                "value_type": "numeric",
                "numeric_normal_min": 4.0,
                "numeric_normal_max": 10.0,
                "unit": cls.g_l,  # Assuming g/L for WBC
            },
        )
        cls.platelets, _ = LabValue.objects.get_or_create(
            ...
            defaults={
                ...
                "name_en": "Platelets",
                "value_type": "numeric",
                "numeric_normal_min": 150.0,
                "numeric_normal_max": 400.0,
                "unit": cls.g_l,  # Assuming g/L for Platelets
            },
        )
        cls.creatinine, _ = LabValue.objects.get_or_create(
            ...
            defaults={
                ...
                "name_en": "Creatinine",
                "value_type": "numeric",
                "numeric_normal_min": 60.0,
                "numeric_normal_max": 120.0,
                "unit": cls.umol_l,
            },
        )
        cls.inr, _ = LabValue.objects.get_or_create(
            ...
            defaults={
                ...
                "name_en": "INR",
                "value_type": "numeric",
                "numeric_normal_min": 0.8,
                "numeric_normal_max": 1.2,
                "unit": cls.ratio_unit,
            },
        )
    ...
    def _create_patient_lab_value(self, patient, lab_value_def, value, days_ago=1):
        ...
        return PatientLabValue.objects.create(
            patient=patient, lab_value=lab_value_def, value=value, datetime=timezone.now() - datetime.timedelta(days=days_ago)
        )
