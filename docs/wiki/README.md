# Wiki Draft Pages (New Setup)

## Purpose
This folder contains draft wiki pages for the new setup and dataloader workflow.

These files are intended to become the canonical documentation after implementation is stable.
