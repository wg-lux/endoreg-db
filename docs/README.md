...
- `docs/video_hls_permissions_and_streaming.md`: current authentication, RBAC, center scope, encrypted HLS delivery, frontend playback, and operational diagnosis contract
