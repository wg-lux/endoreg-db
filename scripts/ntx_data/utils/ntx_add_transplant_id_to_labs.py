...
def get_transplant_id_for_lab_record(
    ...
    if len(valid_transplant_ids) == 1:
        ...
        valid_transplant_id_date_tuples = [
            (transplant_id, readout_data_by_transplant_id[transplant_id].transplant_date)
...
if __name__ == "__main__":
    ...
    patient_data_by_id_ntx = {
        patient_data.patient_id_ntx: patient_data
        for patient_data in patient_data_list
    }

    readout_data_by_transplant_id = {
        readout_data.transplant_id: readout_data
